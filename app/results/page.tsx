...
function ResultsContent() {
  ...
  const DiagnosticTooltip = ({ 
    ...
    <span className="group relative inline-block ml-1">
      ...
      <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 hidden group-hover:block w-72 p-4 bg-white text-slate-800 text-xs rounded-2xl shadow-2xl z-50 border border-slate-100 whitespace-normal normal-case font-normal leading-relaxed">
